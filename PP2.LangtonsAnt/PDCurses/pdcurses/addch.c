...
(U+110000) next to it.  (That part is actually rather simple.)
...
broken.  It also would have resulted in rewriting a _lot_ of code,
so this is probably a better solution anyway.         */
